            ...
            <div class="row w-80">
                ...
                <div class="col">
                    ...
                    <form method="POST" action="{{route('carts.store')}}" class="m-3 align-items-end">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <button type="submit" class="btn ecmart-submit-button w-90">
                            ...
                            <div class="col-6">
                                ...
                                <a href="{{ route('products.favorite', $product) }}" class="btn ecmart-favorite-button text-favorite w-100">
                    ...
                    <div class="row">
                        <div class="offset-md-5 col-md-5">
                            <form method="POST" action="{{ route('reviews.store') }}">
                                ...
                                <button type="submit" class="btn ecmart-submit-button ml-2">レビューを追加</button>
                            </form>
                        </div>
                    </div>
                    @endauth
