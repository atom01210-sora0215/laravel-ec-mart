...
<div class="container d-flex justify-content-center mt-3">
    <div class="w-80">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <form action="{{route('carts.remove', $cart->rowId)}}" name="rowId" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="w-20 mt-4 d-flex align-items-center">
                        削除
                    </button>
                </form>
            </div>
        ...
        <form method="post" action="{{route('carts.destroy')}}" class="d-flex justify-content-end mt-3">
            ...
            <a href="{{route('products.index')}}" class="btn ecmart-favorite-button border-dark text-dark mr-3">
                買い物を続ける
            </a>
            @if ($total > 0)
            <div class="btn ecmart-submit-button" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div>
            @else
            <div class="btn ecmart-submit-button disabled" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div>
            @endif
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn ecmart-favorite-button border-dark text-dark" data-bs-dismiss="modal">閉じる</button>
