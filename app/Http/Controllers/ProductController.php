...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->category !== null){
            $products = Product::where('category_id', $request->category)->sortable()
    ...
    public function show(Request $request, Product $product)
    {
        ...
        if ($request->category !== null){
            $products = Product::where('category_id', $request->category)->sortable()->paginate(12);
            $total_count = Product::where('category_id', $request->category)->count();
            $category = Category::find($request->category);
            $major_category = MajorCategory::find($category->major_category_id);
        } else {
        ...
        return view('products.show', compact('product', 'reviews', 'products', 'category', 'categories', 'major_category', 'major_categories', 'total_count'));
    }
